...
<div class="container">
    ...
    <div class="top-advertisement">
        <img id="ad-image" src="./assets/img/Advertisement1.png" alt="Advertisement Image" class="top-ad-img">
    </div>
    <div class="row">
...
<script>
    const images = [
        './assets/img/Advertisement1.jpg',
        './assets/img/Advertisement2.jpg',
        './assets/img/Advertisement3.jpg'
    ];
    let currentIndex = 0;

    function changeImage() {
        currentIndex = (currentIndex + 1) % images.length;
        document.getElementById('ad-image').src = images[currentIndex];
    }

    setInterval(changeImage, 3000); // Chuyển đổi ảnh sau mỗi 3 giây
</script>
