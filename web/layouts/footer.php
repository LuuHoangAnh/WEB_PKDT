            ...
            <div class="footer__top">
                ...
                <div class="footer__column">
                    ...
                    <ul class="footer__list">
                        <li class="footer__item">
                            <a href="help-center.php" class="footer__link">Gửi phản hồi</a>
                        </li>
                        <li class="footer__item">
                            <a href="help-center.php" class="footer__link">Hỗ trợ tài khoản</a>
                        </li>
                    </ul>
                </div>
                <!-- column 2 -->
                <div class="footer__column">
                    ...
                    <div class="footer__social">
                        <a href="https://www.facebook.com/hoanganh.luu.14019" class="footer__social-btn">
